...
const CertifiItemHeader = styled.TouchableOpacity`
    display:flex;
    flex-direction:row;
...
const CertifiItemBody = styled.View`
    display:flex;
    flex-direction:column; 
    align-items:center;
    padding:20px 10px;
`
const CertifiItemText = styled.Text`
    margin-top:30px;
`; 
        ...
        <CertifiItem>
            <CertifiItemHeader onPress={()=>setToggle(prev=>!prev)}>
                <BoldText>{type}</BoldText>
                {
                    toggle 
                    ?  
                        <NavIcon name={"md-arrow-dropdown"} size={20} /> 
                    :
                        <NavIcon name={"md-arrow-dropup"} size={20} /> 
                }
            </CertifiItemHeader>
            {
                toggle
